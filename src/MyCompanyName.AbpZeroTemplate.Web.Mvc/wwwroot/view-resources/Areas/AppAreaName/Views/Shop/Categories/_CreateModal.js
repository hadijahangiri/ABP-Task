(function ($) {
    ...
    //  },
    //  app.localize('CategoryName_Regex_Description')
    //  );
    ...
    app.modals.CreateCategoryModal = function () {
        ...
        this.init = function (modalManager) {
            ...
            _$categoryInformationForm = modal.find('form[name=CategoryInformationsForm]');
            //_$categoryInformationForm.validate({
            //  rules: {
            //    TenancyName: {
            //      tenancyNameRegex: new RegExp(_$categoryInformationForm.find('input[name=Name]').attr('regex')),
            //    },
            //  },
            //});
            ...
            //var passwordInputGroups = passwordInputs.closest('.category-admin-password');

            //_passwordComplexityHelper.setPasswordComplexityRules(passwordInputs, window.passwordComplexitySetting);

            //$('#CreateCategory_SetRandomPassword').change(function () {
            //  if ($(this).is(':checked')) {
            ...
            //$('#CreateCategory_UseHostDb').change(function () {
            //  if ($(this).is(':checked')) {
            ...
            //  timePicker: true,
            //  parentEl: '#CreateCategoryInformationsForm',
            ...
            //var $isUnlimitedInput = modal.find('#CreateCategory_IsUnlimited');
            ...
            //var $isInTrialPeriodInputDiv = modal.find('#CreateCategory_IsInTrialPeriod').closest('div');
            //var $isInTrialPeriodInput = modal.find('#CreateCategory_IsInTrialPeriod');
        ...
        this.save = function () {
            ...
            //if ($('#CreateCategory_IsUnlimited').is(':visible') && !$('#CreateCategory_IsUnlimited').is(':checked')) {
            //    category.SubscriptionEndDateUtc = $selectedDateTime.startDate.format('YYYY-MM-DDTHH:mm:ss') + 'Z';
            //} else {
            //  category.SubscriptionEndDateUtc = null;
            //}

            //if ($('#CreateCategory_IsUnlimited').is(':checked')) {
            //  category.IsInTrialPeriod = false;
            //}

            //if (category.SetRandomPassword) {
            //  category.Password = null;
            //  category.AdminPassword = null;
            //}

            //if (category.UseHostDb) {
            //  category.ConnectionString = null;
            //}
